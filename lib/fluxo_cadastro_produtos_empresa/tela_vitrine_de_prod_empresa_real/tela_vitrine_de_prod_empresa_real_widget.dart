...
import 'tela_vitrine_de_prod_empresa_real_model.dart';
export 'tela_vitrine_de_prod_empresa_real_model.dart';

class TelaVitrineDeProdEmpresaRealWidget extends StatefulWidget {
  const TelaVitrineDeProdEmpresaRealWidget({super.key});

  @override
  State<TelaVitrineDeProdEmpresaRealWidget> createState() =>
      _TelaVitrineDeProdEmpresaRealWidgetState();
}

class _TelaVitrineDeProdEmpresaRealWidgetState
    extends State<TelaVitrineDeProdEmpresaRealWidget> {
  late TelaVitrineDeProdEmpresaRealModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaVitrineDeProdEmpresaRealModel());
