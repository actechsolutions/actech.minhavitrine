...
import 'tela_add_produto_empresa_model.dart';
export 'tela_add_produto_empresa_model.dart';

class TelaAddProdutoEmpresaWidget extends StatefulWidget {
  const TelaAddProdutoEmpresaWidget({super.key});

  @override
  State<TelaAddProdutoEmpresaWidget> createState() =>
      _TelaAddProdutoEmpresaWidgetState();
}

class _TelaAddProdutoEmpresaWidgetState
    extends State<TelaAddProdutoEmpresaWidget> {
  late TelaAddProdutoEmpresaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaAddProdutoEmpresaModel());
                                          ...
                                          return SingleChildScrollView(
                                            ...
                                            child: Row(
                                              ...
                                              children: List.generate(
                                                  imgProduto.length,
                                                  (imgProdutoIndex) {
                                                final imgProdutoItem =
                                                    imgProduto[imgProdutoIndex];
                                                return Container(
                                                  width: 100.0,
                                                  height: 100.0,
                                      ...
                                      Padding(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final dropDownBuscarCategoriaPorUserIdResponse =
                                                snapshot.data!;
                                            return FlutterFlowDropDown<String>(
                                              ...
                                              options: (getJsonField(
                                                dropDownBuscarCategoriaPorUserIdResponse
                                                    .jsonBody,
                                                r'''$[:].nmCategoria''',
                                                true,
                                              ) as List)
