...
class HoraInterceptorPut extends FFApiInterceptor {
  get substring => null;
      ...
      try {
        ...
        if (responseBody != null && responseBody.isNotEmpty) {
          ...
          if (responseBody != null && responseBody is Map<String, dynamic>) {
            ...
            if (responseBody.containsKey('horarioEntrada')) {
              print('Chave "horarioEntrada" encontrada no mapa.');

              // Obtém o valor do campo 'horarioEntrada' e converte para String
              String horarioEntrada = responseBody['horarioEntrada'].toString();
              String horarioSaida = responseBody['horarioSaida'].toString();
              String almocoEntrada = responseBody['almocoEntrada'].toString();
              String almocoSaida = responseBody['almocoSaida'].toString();
